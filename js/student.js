...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    if (student) {
        ...
        document.getElementById("lab1-image").src = "assets/lab_images/lab1/"+ studentId + "_lab1.png" || "assets/student_images/placeholder.png";
        document.getElementById("lab1-image").alt = "Lab 1";
        document.getElementById("lab1-description").innerText = student.lab1;

        document.getElementById("lab2-image").src = "assets/lab_images/lab2/"+ studentId + "_lab2.png" || "assets/student_images/placeholder.png";
